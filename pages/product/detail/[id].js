        ...
        <div>
            ...
            <Container>
                <Breadcrumb className="pb-2 pt-3 breadcrumb-custom" style={{ background: '#e9ecef' }}>
                    ...
                    <Breadcrumb.Item active>Detail - {props.title}</Breadcrumb.Item>
                </Breadcrumb>
            </Container>
            ...
            >
                ...
                <Modal.Body>
                    <Row>
                        <Image src={props.attacments[0]} rounded fluid />
                        <Col>
                            <p className="font-weight-bold">{props.title}</p>
                            <p className="font-weight-light"><MoneyFormat value={props.price} /></p>
                        </Col>
                    </Row>
                </Modal.Body>
                <Modal.Footer>
...
export async function getServerSideProps(context) {
    ...
    // Fetch data from external API deatail product
    const res = await fetch(`${process.env.url}/api/product/${context.params.id}`)
